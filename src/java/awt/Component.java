/*
 * @(#)Component.java	1.66 96/01/18 Arthur van Hoff
 *
...
public abstract class Component implements ImageObserver {
     ...
     * Component, where x and y are defined to be relative to the 
	...
	/* this should be handled by overriding postEvent in
	 * Window, however since that breaks compatibility, we'll
	 * add this check here for now.
	 */
	if (this instanceof Window) {
	    Window window = (Window)this;
	    if (window.handleTabEvent(e)) {
		return true;
	    }
	} else {
